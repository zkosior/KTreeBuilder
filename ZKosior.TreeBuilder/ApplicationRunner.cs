...
namespace ZKosior.TreeBuilder
{
    ...
    public class ApplicationRunner
    {
        ...
        /// </summary>
        /// <param name="knaryTreeApp">
        /// The k-nary tree app.
        /// </param>
        public ApplicationRunner(KnaryTreeApp knaryTreeApp)
        {
            ...
            this.KnaryTreeApp = knaryTreeApp;
        }
        ...
        /// <summary>
        /// Gets or sets the k-nary tree app.
        /// </summary>
        private KnaryTreeApp KnaryTreeApp { get; set; }
        ...
        public void Run(string[] args)
        {
            try
            {
                ...
                {
                    this.KnaryTreeApp.ParseData(this.GetInputStream(), this.GetOutputStream());
        ...
        private bool ValidateParameters(string[] args)
        {
            if (args.Length < 1)
            {
                ...
                this.WriteToConsole(@"TreeBuilder Data\Test01_input.txt");
                this.WriteToConsole(@"TreeBuilder Data\Test01_input.txt Data\Test01_output.txt");
                return false;
            }
